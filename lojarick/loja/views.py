...
def gerar_form_busca(request):
    if request.is_ajax() and request.method == "POST":
        ...
        # nome
        form_busca += "<td colspan=2><label for='nome' style='font-weight: bold; color: #3a87ad;'>Nome</label>"
        ...
        # form_busca += "<input type='number' name='preco'></td>"
        ...
        for caract in caracteristicas:
            ...
            # INPUT QUE DEVE SER ALTERADO DEPENDENDO O TIPO_CAMPO DA CARACTERISTICA,
            if caract.possui_relacionamento:
                ...
                form_busca += "</select>"
            # O NOME DO INPUT OU SELECT DEVE MANTER O ID DA CARACTERISTICA
            else:
