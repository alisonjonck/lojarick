...
# Database: lojarick
# Generation Time: 2013-07-04 20:57:40 +0000
# ************************************************************
...
VALUES
	(1,'alison','','','alison@alison.com','pbkdf2_sha256$10000$H5dfoBuQqb9z$EAM6RWzwuWrQb0T576575hkibhKv/PC288NgWAldvrc=',1,1,1,'2013-06-21 17:31:14','2013-06-07 14:02:26');
...
# Dump of table booleanos
# ------------------------------------------------------------

DROP TABLE IF EXISTS `booleanos`;
...
LOCK TABLES `booleanos` WRITE;
/*!40000 ALTER TABLE `booleanos` DISABLE KEYS */;

INSERT INTO `booleanos` (`id`, `nome`)
VALUES
	(1,'Sim'),
	(2,'Não');

/*!40000 ALTER TABLE `booleanos` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(64,'2013-06-23 20:29:26',1,8,'6','Violão',2,'Adicionado tipo caracteristica \"Quantidade de cordas\" Adicionado tipo caracteristica \"Cor do instrumento\" Adicionado tipo caracteristica \"Tipo da madeira\"'),
	(65,'2013-06-26 12:11:22',1,10,'8','Violão do Guilherme',1,''),
	(66,'2013-06-28 15:58:36',1,8,'1','Guitarra',2,'Deletado tipo caracteristica \"Modelo\".'),
	(67,'2013-07-02 14:46:54',1,8,'11','Viola',1,''),
	(68,'2013-07-02 14:50:59',1,10,'9','asdf',1,''),
	(69,'2013-07-04 20:34:40',1,8,'2','Bateria',2,'Modificado tipo_campo, possui_relacionamento e tabela_relacionamento para tipo caracteristica \"Bateria eletrônica\".');
...
VALUES
	...
	('qychhbg4ez7dnc26omnq0pnrxsf23q2h','YzZiYTRlNTBiMDdkMzJjMjIzZGRmMzFlMzgxNGU0ZGIwZjEyOTFjNjqAAn1xAShVEl9hdXRoX3VzZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHEDVQ1fYXV0aF91c2VyX2lkcQSKAQF1Lg==','2013-07-05 17:31:14');
...
VALUES
	...
	(8,'Violão do Guilherme',6,3,100.00,'img/guitar_1.jpeg'),
	(9,'asdf',1,1,12.00,'');
...
VALUES
	...
	(4,'Bateria eletrônica',1,2,1,'booleanos'),
	...
	(16,'Quantidade de cordas',2,6,0,''),
	(17,'Cor do instrumento',1,6,1,'cores'),
	(18,'Tipo da madeira',1,6,1,'tipos_madeira'),
	(19,'Quantidade de cordas',2,11,0,''),
	(20,'Cor do instrumento',1,11,1,'cores'),
	(21,'Tipo de corda',1,11,1,'tipos_madeira');
